...
For example:
- "Not needed. But close the tasks related to the vendor." → has_other_content=true, other_content_text="close the tasks related to the vendor"
- "No" → has_other_content=false
- "Yes, do these and also close the client project task" → decisions are confirm for proposed items, has_other_content=true, other_content_text="close the client project task"
...
4. 'task_closure' — explicit instruction to close, cancel, or mark-as-done an existing task ("close the tasks related to the vendor", "mark the pilot tasks done", "cancel the client project task"). Include the description of which tasks to close in "target_task_description".
...
{{
  "signals": [
    {{
      ...
      "target_task_description": "Description of which tasks to close (for task_closure only — e.g., 'tasks related to the vendor', 'pilot tasks')",
