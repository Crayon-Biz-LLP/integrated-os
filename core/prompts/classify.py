...
def build_classify_intent_prompt(
    ...
    """Build the intent-classification prompt (M2 de-personalized).
...
- STRICT TITLE FIDELITY: The title field must be a literal extraction of the task as spoken. NEVER add project names, infer entities, or change {user_name}'s wording (e.g., if he says "this OS," do NOT change it to "Qhord OS").
...
- LITERAL SUBJECT: Mirror {user_name}'s verb. 'Check with Vasanth' → "Vasanth check-in logged."
