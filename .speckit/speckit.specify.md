...
- **32-test verification suite**: 19 LIVE_DB simulation tests (T1–T14) + 13 unit tests covering context registry gates, pre-flight isolation, hallucination claim stripping, JSON fallback, and session continuity. All verified against real Supabase.
