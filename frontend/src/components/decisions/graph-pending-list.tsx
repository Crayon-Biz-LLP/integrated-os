...
const RELATIONSHIP_OPTIONS = [
  ...
  { value: 'KNOWS', group: 'Person → Person', desc: 'General acquaintance' },
  { value: 'DISCUSSED_WITH', group: 'Person → Person', desc: 'Conversations (phone/chat)' },
  { value: 'MENTORS', group: 'Person → Person', desc: 'Mentorship relationship' },
  ...
  { value: 'MEMBER_OF', group: 'Person → Organization', desc: 'Formal membership' },
  { value: 'SERVES_AT', group: 'Person → Organization', desc: 'Ministry / volunteer service' },
