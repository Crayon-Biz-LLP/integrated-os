...
| [63-comprehensive-user-testing-plan.md](63-comprehensive-user-testing-plan.md) | **UAT Test Plan** — 158-scenario end-to-end manual/automated test suite across all 6 layers, gap analysis (+58 scenarios), test run tracking, verification queries |
| [99-architecture-reference.md](99-architecture-reference.md) | **Consolidated architecture reference** — single-source 6-layer overview with key files, metrics, and cross-references |
