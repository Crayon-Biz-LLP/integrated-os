...
4. `email_pending_tasks` row created: *"Revise Q3 quote for Solvstrat client"* → project: Solvstrat
...
4. EgoGraph zooms to Qhord's ego network:
   ...
   - 3 resource nodes linked to Qhord GTM mission
...
1. `retrieve_hindsight_memories()` fires 5 parallel queries:
   ...
   - **Resources**: Resources tagged with Solvstrat mission
