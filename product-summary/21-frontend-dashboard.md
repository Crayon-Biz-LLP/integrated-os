...
### Resources Module
Library grid with title, URL, category, mission assignment. Mission group view. View toggle (grid/list). Stats by category/mission.
...
| Resources | Count by category, mission-linked vs. unlinked |
